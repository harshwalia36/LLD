package main.java.com.harshwalia.service;

import main.java.com.harshwalia.exception.ParkingLotException;
import main.java.com.harshwalia.model.Car;
import main.java.com.harshwalia.model.ParkingLot;
import main.java.com.harshwalia.model.Slot;
import main.java.com.harshwalia.model.parking.strategy.ParkingStrategy;
...
public class ParkingLotService {
    ...
    public void createParkingLot(final ParkingLot parkingLot, final ParkingStrategy parkingStrategy) {
        ...
        for (int i = 0; i < parkingLot.getCapacity(); i++) {
            parkingStrategy.addSlot(i); // full capacity is available add all slots
        }
    }
    ...
    public Integer park(final Car car) {
        ...
        parkingStrategy.removeSlot(nextFreeSlot); // this slot get filled and removed from parking strategy
        return nextFreeSlot;
    }
